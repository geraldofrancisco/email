...
public class EmailConstants {
  ...
  public static final String EMAIL_CREATE_REQUEST_EMAIL_TYPE_ID_REQUIRED = "EMAIL_CREATE_REQUEST_EMAIL_TYPE_ID_REQUIRED";
  public static final String EMAIL_CREATE_REQUEST_EMAIL_TYPE_ID_INVALID = "EMAIL_CREATE_REQUEST_EMAIL_TYPE_ID_INVALID";
  public static final String EMAIL_CREATE_REQUEST_FIELD_VALUES_FIELD_REQUIRED = "EMAIL_CREATE_REQUEST_FIELD_VALUES_FIELD_REQUIRED";
  public static final String EMAIL_CREATE_REQUEST_FIELD_VALUES_VALUE_REQUIRED = "EMAIL_CREATE_REQUEST_FIELD_VALUES_VALUE_REQUIRED";
}
